...
VALUES 
('Gerson Lamed Saenz', 'lamed.saenz@gmail.com', '12345', 'Admin'),
('Administrador2', 'admin2@example.com', '12345', 'Admin'),
('Auxiliar Registro 1', 'auxiliar1@example.com', '12345', 'Aux'),
('Auxiliar Registro 2', 'auxiliar2@example.com', '12345', 'Aux'),
('Auxiliar Registro 3', 'auxiliar3@example.com', '12345', 'Aux'),
('Administrador Tercero', 'admin3@example.com', '12345', 'Admin'),
('Auxiliar Registro 4', 'auxiliar4@example.com', '12345', 'Aux'),
('Auxiliar Registro 5', 'auxiliar5@example.com', '12345', 'Aux'),
('Administrador Cuarto', 'admin4@example.com', '12345', 'Admin'),
('Auxiliar Registro 6', 'auxiliar6@example.com', '12345', 'Aux');

INSERT INTO public.comerciante(
	nombre_completo, ciudad, telefono, correo_electronico, estado, usuario_actualizacion)
VALUES 
('Gerson Saenz', 'Bogotá', '3142540356', 'lamed.saenz@gmail.com', 'Activo', 1),
('Comerciante 2', 'Cartagena', '222222222', 'com2@example.com', 'Activo', 1),
('Comerciante 3', 'Barranquilla', '333333333', 'com3@example.com', 'Activo', 1),
('Comerciante 4', 'Bogotá', '444444444', 'com4@example.com', 'Activo', 1),
('Comerciante 5', 'Bogotá', '555555555', 'com5@example.com', 'Activo', 1),
('Comerciante 6', 'Cali', '666666666', 'com6@example.com', 'Activo', 1),
('Comerciante 7', 'Bogotá', '777777777', 'com7@example.com', 'Activo', 1),
('Comerciante 8', 'Bogotá', '888888888', 'com8@example.com', 'Activo', 1),
('Comerciante 9', 'Bogotá', '999999999', 'com9@example.com', 'Activo', 1),
('Comerciante 10', 'Bogotá', '123456789', 'com10@example.com', 'Activo', 1),
('Comerciante 11', 'Medellín', '1111222233', 'com11@example.com', 'Inactivo', 1);

INSERT INTO establecimiento (nombre_establecimiento, ingresos, numero_empleados, id_comerciante, usuario_actualizacion)
VALUES 
('Establecimiento_1', 100000.50, 10, 2, 1),
('Establecimiento_2', 250000.00, 15, 3, 1),
('Establecimiento_3', 30000.75, 5, 4, 2),
('Establecimiento_4', 450000.00, 20, 5, 2),
('Establecimiento_5', 125000.40, 8, 6, 1),
('Establecimiento_6', 210000.00, 12, 7, 3),
('Establecimiento_7', 185000.25, 18, 8, 3),
('Establecimiento_8', 175000.00, 9, 9, 4),
('Establecimiento_9', 50000.00, 4, 10, 4),
('Establecimiento_10', 320000.00, 11, 8, 5);

INSERT INTO municipios (departamento, provincia, cod_muni, nombre_muni, nombre) VALUES
